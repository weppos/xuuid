...
This document describes the steps to release a new version of xuuid.
...
- Verify the new version appears on [GitHub releases](https://github.com/weppos/xuuid/releases)
- Wait a few minutes for the Go module proxy to index the new version
- Test installation:

  ```shell
  go install github.com/weppos/xuuid@v$VERSION
  ```
